...
| <a name="input_chart_repository"></a> [chart\_repository](#input\_chart\_repository) | Repository URL where to locate the requested chart. | `string` | `"https://kubernetes-sigs.github.io/metrics-server/"` | no |
...
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | Specify the exact chart version to install. If this is not specified, the latest version is installed. | `string` | `"3.11.0"` | no |
...
| <a name="input_metrics_server_component"></a> [metrics\_server\_component](#input\_metrics\_server\_component) | The name of the Metrics Server component | `string` | `"eks-metrics-server"` | no |
